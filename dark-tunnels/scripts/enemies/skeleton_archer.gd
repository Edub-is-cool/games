...
@export var loot_gold_min: int = 8
@export var loot_gold_max: int = 18
...
func _attack() -> void:
	...
	var arrow_scene: PackedScene = preload("res://scenes/magic/skeleton_arrow.tscn")
	var arrow: Node3D = arrow_scene.instantiate()
	get_tree().current_scene.add_child(arrow)
	arrow.global_position = global_position + Vector3(0, 1.0, 0)
	var dir: Vector3 = (player.global_position + Vector3(0, 1, 0) - arrow.global_position).normalized()
	arrow.direction = dir
	arrow.damage = damage
